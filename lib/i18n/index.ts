...
const resources = {
    en: {
        ...
        translation: {
            ...
            seniorPosition: 'Lab Technician',
            seniorCompany: 'ZF Wind Power Antwerpen NV',
            seniorLocation: 'Lommel',
            senPeriod: '2011 - current',
            seniorDescription:
                'Conducted tests and analyses on wind turbine components to ensure quality and performance standards. Collaborating with engineering teams in an international context to develop testing protocols and improve product reliability. Implemented a new data analysis system that reduced reporting time by 30%.',
            senSkills: [
            ...
            midPosition: 'CNC-Operator',
            midCompany: 'Hansen Transmissions NV',
            midLocation: 'Lommel',
            midPeriod: '2003 - 2011',
            midDescription:
                'Manufactured precision components for wind turbine gearboxes using CNC machines. Worked closely with engineers to optimize machining processes and improve product quality. Trained new operators on machine setup and safety protocols.',
            midSkills: [
                'CNC Programming',
    ...
    fr: {
        ...
        translation: {
            ...
            seniorPosition: 'Technicien de laboratoire',
            seniorCompany: 'ZF Wind Power Antwerpen NV',
            seniorLocation: 'Lommel',
            senPeriod: '2011 - actuel',
            seniorDescription:
                'Réalisation de tests et d’analyses sur des composants d’éoliennes afin de garantir les normes de qualité et de performance. Collaboration avec des équipes d’ingénierie dans un contexte international pour développer des protocoles d’essai et améliorer la fiabilité des produits. Mise en place d’un nouveau système d’analyse de données ayant réduit le temps de rapport de 30%.',
            senSkills: [
            ...
            midPosition: 'Opérateur CNC',
            midCompany: 'Hansen Transmissions NV',
            midLocation: 'Lommel',
            midPeriod: '2003 - 2011',
            midDescription:
                'Fabrication de composants de précision pour les multiplicateurs d’éoliennes à l’aide de machines CNC. Collaboration étroite avec les ingénieurs pour optimiser les processus d’usinage et améliorer la qualité des produits. Formation des nouveaux opérateurs à la configuration des machines et aux protocoles de sécurité.',
            midSkills: [
                'Programmation CNC',
    ...
    de: {
        ...
        translation: {
            ...
            seniorPosition: 'Labortechniker',
            seniorCompany: 'ZF Wind Power Antwerpen NV',
            seniorLocation: 'Lommel',
            senPeriod: '2011 - aktuell',
            seniorDescription:
                'Durchführung von Tests und Analysen an Komponenten von Windkraftanlagen zur Sicherstellung der Qualitäts- und Leistungsstandards. Zusammenarbeit mit Ingenieurteams in einem internationalen Umfeld zur Entwicklung von Testprotokollen und zur Verbesserung der Produktzuverlässigkeit. Implementierung eines neuen Datenanalyse-Systems, das die Berichtszeit um 30 % reduzierte.',
            senSkills: [
            ...
            midPosition: 'CNC-Maschinenbediener',
            midCompany: 'Hansen Transmissions NV',
            midLocation: 'Lommel',
            midPeriod: '2003 - 2011',
            midDescription:
                'Herstellung von Präzisionskomponenten für Getriebe von Windkraftanlagen mittels CNC-Maschinen. Enge Zusammenarbeit mit Ingenieuren zur Optimierung der Bearbeitungsprozesse und Verbesserung der Produktqualität. Schulung neuer Bediener in der Maschinenkonfiguration und den Sicherheitsprotokollen.',
            midSkills: [
                'CNC-Programmierung',
                'Messtechniken',
            ...
            studies: {
                ...
                items: [
                    {
                        degree: 'Assoziierter Abschluss in Software- und Anwendungsentwicklung',
                        institution: 'Thomas More Kempen',
    ...
    nl: {
        ...
        translation: {
            ...
            seniorPosition: 'Lab technieker',
            seniorCompany: 'ZF Wind Power Antwerpen NV',
            seniorLocation: 'Lommel',
            senPeriod: '2011 - heden',
            seniorDescription:
                'Uitvoeren van testen en analyses op onderdelen van windturbines om de kwaliteits- en prestatie-eisen te waarborgen. Samenwerking met engineeringteams in een internationale context om testprotocollen te ontwikkelen en de betrouwbaarheid van producten te verbeteren. Implementatie van een nieuw data-analysesysteem dat de rapportagetijd met 30% heeft verminderd.',
            senSkills: [
            ...
            midPeriod: '2003 - 2011',
            midDescription:
                'Produceren van precisieonderdelen voor tandwielkasten van windturbines met behulp van CNC-machines. Nauw samenwerken met ingenieurs om bewerkingsprocessen te optimaliseren en de productkwaliteit te verbeteren. Opleiden van nieuwe operators in het instellen van machines en veiligheidsprotocollen.',
            midSkills: [
                'CNC-programmeren',
                'Meettechnieken',
